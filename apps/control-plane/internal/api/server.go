	...
	s.router.Route("/api/v1", func(r chi.Router) {
		...
		if s.projectHandler != nil {
			r.Group(func(r chi.Router) {
				...
				r.Get("/projects/portfolio", s.projectHandler.GetProjectPortfolio)
				r.Get("/projects/run-summary", s.projectHandler.ListProjectRunSummaries)
				// Workspace directory delete confirmation queue (static paths before {projectId}).
				r.Post("/projects/workspace/probe", s.projectHandler.ProbeProjectDirectory)
				r.Get("/projects/workspace-delete-requests", s.projectHandler.ListWorkspaceDeleteRequests)
				r.Post("/projects/workspace-delete-requests/{requestId}/confirm", s.projectHandler.ConfirmWorkspaceDelete)
				r.Post("/projects/workspace-delete-requests/{requestId}/reject", s.projectHandler.RejectWorkspaceDelete)
				...
				r.Post("/projects/{projectId}/unarchive", s.projectHandler.UnarchiveProject)
				...
				r.Get("/projects/{projectId}/tasks/{taskId}", s.projectHandler.GetProjectTask)
				...
				r.Post("/project-demands/{demandId}/continuations", s.projectHandler.ContinueDemand)
		...
		if s.tenantHandler != nil {
			r.Group(func(r chi.Router) {
				...
				r.Get("/teams/pending-deletes", s.tenantHandler.ListPendingDeleteTeams)
				r.Post("/teams/{teamId}/restore", s.tenantHandler.RestorePendingDeleteTeam)
				r.Post("/teams/{teamId}/confirm-delete", s.tenantHandler.ConfirmTeamDelete)
				r.Patch("/teams/{teamId}/constitution", s.tenantHandler.UpdateTeamConstitution)
				r.Put("/teams/{teamId}/constitution/revisions", s.tenantHandler.SaveTeamConstitution)
				r.Get("/teams/{teamId}/constitution/revisions", s.tenantHandler.ListTeamConstitutionRevisions)
				r.Post("/teams/{teamId}/constitution/revisions/{revisionNumber}/rollback", s.tenantHandler.RollbackTeamConstitution)
		...
		if s.skillHandler != nil {
			r.Group(func(r chi.Router) {
				...
				r.Get("/projects/{projectId}/skill-bindings", s.skillHandler.ListProjectSkillBindings)
				r.Put("/projects/{projectId}/skill-bindings", s.skillHandler.PutProjectSkillBindings)
			})
		}
		...
		r.Route("/runtime", func(r chi.Router) {
			...
			r.Group(func(r chi.Router) {
				...
				r.Get("/nodes/{nodeId}/provider-native-configs", s.runtimeHandler.ListProviderNativeConfigs)
				r.Post("/nodes/{nodeId}/provider-native-configs/pull", s.runtimeHandler.PullProviderNativeConfig)
				r.Get("/nodes/{nodeId}/provider-native-configs/{providerType}/{configKey}", s.runtimeHandler.GetProviderNativeConfig)
				r.Put("/nodes/{nodeId}/provider-native-configs/{providerType}/{configKey}", s.runtimeHandler.PushProviderNativeConfig)

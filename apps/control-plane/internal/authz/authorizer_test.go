...
func TestDBAuthorizerUserProjectTeamScopeActionsRequireTenantOwnerOrAdmin(t *testing.T) {
	tenantID := uuid.MustParse("00000000-0000-0000-0000-000000000001")

	for _, action := range []string{ActionUserProjectTeamScopeRead, ActionUserProjectTeamScopeManage} {

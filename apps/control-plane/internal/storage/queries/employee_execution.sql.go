...
const CreateDigitalEmployeeExecutionInstance = `-- name: CreateDigitalEmployeeExecutionInstance :one
...
type CreateDigitalEmployeeExecutionInstanceParams struct {
	TenantID             uuid.UUID `json:"tenant_id"`
...
func (q *Queries) CreateDigitalEmployeeExecutionInstance(ctx context.Context, arg CreateDigitalEmployeeExecutionInstanceParams) (DigitalEmployeeExecutionInstance, error) {
	row := q.db.QueryRow(ctx, CreateDigitalEmployeeExecutionInstance,
		arg.TenantID,

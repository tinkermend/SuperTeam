...
SELECT id, tenant_id, slug, name, status, metadata, archived_at, disabled_at, deleted_at, created_at, updated_at, human_owner_user_ids, constitution, delete_requested_by FROM tenant_teams
WHERE tenant_id = $1::uuid
  AND status = 'pending_delete'

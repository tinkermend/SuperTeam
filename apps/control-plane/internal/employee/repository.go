...
type Repository interface {
	...
	// UpdateDigitalEmployeeProfile 写回身份资料（description + role）；空说明落 NULL。
	UpdateDigitalEmployeeProfile(ctx context.Context, tenantID, employeeID uuid.UUID, description *string, role string) (DigitalEmployeeRecord, error)

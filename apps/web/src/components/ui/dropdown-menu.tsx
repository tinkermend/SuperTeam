  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          // Keep close synchronous so a closing DismissableLayer cannot eat
          // the next trigger click when switching lightweight menus quickly.
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        // Match DropdownMenuContent: no close animation, no stale click layer.

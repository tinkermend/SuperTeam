  ...
  return (
    <div className="absolute inset-0">
      <article
        ...
        className={`absolute z-30 w-[196px] rounded-[14px] border bg-white/94 p-3 shadow-card backdrop-blur transition ${selected ? "border-brand ring-2 ring-brand/20" : "border-line opacity-88"}`}

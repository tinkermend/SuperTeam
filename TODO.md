...
- [ ] 2026-08-04 剧本管理页面 UI 大改（人类拍板后期单独立项）——当前模板管理只有裸 JSON textarea + 基础 CRUD，角色词表化后需要：角色注册管理、剧本可视化查看（骨架/约束/收口档位）、编制预览、模板与词表的引用关系。参考批二讨论与 `docs/superpowers/specs/2026-07-29-demand-workbench-design.md` §0.3 的命名约定

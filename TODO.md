...
- [ ] 2026-07-26 执行轨迹面板按任务过滤/高亮——Phase 1 弹层深链只到面板级(?tab=trace 自动展开+定位)；人类拍板随 IA 重构 Phase 2(项目详情重做)一起补,避免同一面板两轮动。参考 `docs/superpowers/specs/2026-07-26-canonical-flow-graph-phase1.md` §4.3/§8

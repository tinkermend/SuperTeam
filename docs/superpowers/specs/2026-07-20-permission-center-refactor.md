...
> 复核状态：权限中心重构已合入main + 真实E2E全PASS(07-20)
...
> **边界注记（2026-07-25）**：成员角色页保持只读观察面；租户成员授予/撤销与控制台访问编辑落在用户管理，不在权限中心做第二套 IAM 编辑器。见 [2026-07-25-tenant-membership-and-console-access](2026-07-25-tenant-membership-and-console-access.md)。
